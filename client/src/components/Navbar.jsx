...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex gap-x-12 max-lg:gap-x-6 max-lg:text-[0.3rem]">
      ...
      <a href="#" className="text-sm max-lg:text-[0.7rem] font-semibold leading-6 text-gray-900">Create Table</a>
      <a href="#" className="text-sm max-lg:text-[0.7rem] font-semibold leading-6 text-gray-900">View Tables</a>
  ...
  </nav>:<div className="lg:hidden" role="dialog" aria-modal="true">
